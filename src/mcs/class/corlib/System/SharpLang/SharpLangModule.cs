...
namespace System
{
    ...
    public class SharpLangModule : Module
    {
        ...
        private static readonly Dictionary<SharpLangEETypeDefinition, SharpLangTypeDefinition> typeDefinitions = new Dictionary<SharpLangEETypeDefinition, SharpLangTypeDefinition>(new DefaultComparer<SharpLangEETypeDefinition>());
        private static readonly Dictionary<SharpLangType, SharpLangTypeElement> pointerTypes = new Dictionary<SharpLangType, SharpLangTypeElement>(new DefaultComparer<SharpLangType>());
        private static readonly Dictionary<SharpLangType, SharpLangTypeElement> byRefTypes = new Dictionary<SharpLangType, SharpLangTypeElement>(new DefaultComparer<SharpLangType>());
        private static readonly Dictionary<SharpLangType, SharpLangTypeElement> arrayTypes = new Dictionary<SharpLangType, SharpLangTypeElement>(new DefaultComparer<SharpLangType>());
        ...
        private readonly Dictionary<Handle, SharpLangModule> moduleHandleCache = new Dictionary<Handle, SharpLangModule>();
        ...
        public SharpLangModule(IntPtr metadataStart, int metadataLength)
        {
            ...
            lock (SystemTypeLock)
            {
                ...
                AppDomain.CurrentDomain.Assemblies.Add(assembly);
            }
        }
            ...
            lock (SystemTypeLock)
            {
                ...
                switch (handle.Kind)
                {
                    case HandleKind.AssemblyReference:
                    {
                        ...
                        foreach (var assembly in AppDomain.CurrentDomain.Assemblies)
                        {
