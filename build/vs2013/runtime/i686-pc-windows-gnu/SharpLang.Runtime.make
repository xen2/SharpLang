...
ifeq ($(config),debug)
  ...
  AR = ar
  LLVM_LINK = llvm-link
  TARGETDIR = ../../lib/runtime/i686-pc-windows-gnu
  TARGET = $(TARGETDIR)/SharpLang.Runtime.bc
  OBJDIR = ../obj/i686-pc-windows-gnu/Debug
  DEFINES += -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -DLIBCXXABI_HAS_NO_THREADS -DUNICODE -D_BLD_CLR -DFEATURE_CORECLR -DFEATURE_BCL_FORMATTING -DFEATURE_COREFX_GLOBALIZATION -DFEATURE_CRYPTO
  ...
  LIBS +=
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -shared -Wl,--out-implib="../../lib/runtime/i686-pc-windows-gnu/SharpLang.Runtime.lib"
...
ifeq ($(config),release)
  ...
  TARGETDIR = ../../lib/runtime/i686-pc-windows-gnu
  TARGET = $(TARGETDIR)/SharpLang.Runtime.bc
  OBJDIR = ../obj/i686-pc-windows-gnu/Release
  DEFINES += -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -DLIBCXXABI_HAS_NO_THREADS -DUNICODE -D_BLD_CLR -DFEATURE_CORECLR -DFEATURE_BCL_FORMATTING -DFEATURE_COREFX_GLOBALIZATION -DFEATURE_CRYPTO
  INCLUDES += -I../../../../deps/llvm/include -I../../../../src/SharpLang.Runtime/coreclr/vm -I../../../../src/SharpLang.Runtime/coreclr/inc -I../../../../src/SharpLang.Runtime/coreclr/classlibnative/inc -I../../../../src/SharpLang.Runtime/coreclr/classlibnative/cryptography -I../../../../deps/llvm/build_x32/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
